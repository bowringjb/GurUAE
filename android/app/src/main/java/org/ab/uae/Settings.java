...
public class Settings extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    Preference configurationLoadFile;
    Preference configurationSaveFile;
    Preference configurationSaveAsFile;
    Preference romPref;
    Preference hddFile;
    Preference hdfFile;
    Preference floppy1;
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        PreferenceCategory configPrefCatagory = new PreferenceCategory(this);
        configPrefCatagory.setTitle(R.string.config_section);
        root.addPreference(configPrefCatagory);

        // Load configuration
        configurationLoadFile = new Preference(this) {
        };
        configurationLoadFile.setTitle(R.string.load_configuration);
        configPrefCatagory.addPreference(configurationLoadFile);

        // Save configuration
        configurationSaveFile = new Preference(this) {
        };
        configurationSaveFile.setTitle(R.string.save_configuration);
        configPrefCatagory.addPreference(configurationSaveFile);

        // Save configuration as
        configurationSaveAsFile = new Preference(this) {
            @Override
            protected void onClick() {
                GetConfigurationFilename();
            }
        };
        configurationSaveAsFile.setTitle(R.string.save_as_configuration);
        configPrefCatagory.addPreference(configurationSaveAsFile);
    ...
    private String ConfigurationSaveName;
    ...
    private void GetConfigurationFilename() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ConfigurationSaveName = input.getText().toString();
            }
        });
